    ...
    <Link href={`/shop/${medicine.id}`}>
      <div className="card group cursor-pointer overflow-hidden">
        ...
        <div className="relative h-44 bg-brand-50 overflow-hidden">
          ...
          {/* Wishlist heart button — top-left when no low-stock badge */}
          <button
            onClick={handleWishlist}
            className={`absolute bottom-2 right-2 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-200 shadow-sm ${
              wishlisted
        ...
        <div className="p-4">
          <h3
            className="font-semibold text-gray-900 text-sm leading-tight mb-1 line-clamp-2 group-hover:text-brand-700 transition-colors"
